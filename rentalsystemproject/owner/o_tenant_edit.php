...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
    ...
    <form action="o_tenant_edit_process.php" method="post">
    ...
    <div class="p-2 py-3"> 
            <h4 class="text-center">Profile Settings</h4> 
                ...
                <div class="row mt-2"> 
                     ...
                     <input clas="form-control"type="hidden"size="10"required name="T_userid" id="T_userid" value="<?php echo $row['T_userid'];?>">
                 ...
                 <div class="row mt-3"> 
                    <div class="col-md-12">
                        ...
                        <input type="text"size="25"required name="last_name" id="last_name"value="<?php echo $row['last_name'];?>">
                    </div> 
                    </div>
                    ...
                    <div class="row mt-3"> 
                        <div class="col-md-6">
                            ...
                            <input type="text"size="10"required name="gender" id="gender"value="<?php echo $row['gender'];?>">
                        </div>
                        ...
                        <input type="text"size="10"required name="T_username" id="T_username"value="<?php echo $row['T_username'];?>">
                        </div>
                        </div>   
