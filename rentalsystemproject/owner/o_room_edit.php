...
// prepare sql and bind parameters
       $statement=$connection->prepare("SELECT  distinct roomID,room_no,images,category,ROOMS.ROOM_CATEGORY_ID,total_beds,almira,wifi,tv,AMENITIES.A_ID FROM ROOMS
...
<form action="o_room_edit_proc.php" method="post">
...
<div class="row"> 
    ...
    <div class="p-4 py-3"> 
            <h4 class="text-center">Room Settings</h4> 
                ...
                <label for="categorys" class="labels">Category</label>
                <br>
                ...
                ?>
                    ...
                    <option value="No">No</option>
                        ...
                        <div class="col-md-6">
                        <label class="labels">T.V.</label>
                        <br>
                        <select name="tv">
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                    </select>
                        <input type="hidden"required name="A_ID" id="A_ID"value="<?php echo $row['A_ID'];?>">
