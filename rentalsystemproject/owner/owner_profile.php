...
try
{
  $username = $_SESSION["username"];
        ...
        $statement=$connection->prepare("SELECT * FROM OWNERS WHERE O_username='$username'  ");
...
?>
         ...
         <h1 style="text-align:center"> Owners Profile </h1>
<div class="container"style="margin-left:320px;display:d-flex;align-items:center">
    ...
    <?php foreach ($result as $row) 
    {
      ?>                  <div class="col-md-4 " >
                            ...
                            <div class="card-body">
                                ...
                                <img src="../images/user.png" width="220px" height="220px" style="border-radius:50%"></p>
                    ...
                    <a href="owner_edit.php?id= <?php echo $row['O_userid']; ?>">
                    <i class='bx bxs-edit' style="margin:10px 20px 0px 80px" ></i></a>
                    
                     <a href="owner_delete.php?id= <?php echo $row['O_userid']; ?>">
