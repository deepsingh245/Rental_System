...
<div class="home-content">
 ...
 <form action="a_tenant_add_proc.php"method="POST">
    ...
    <h3 style="text-align:center">Add New Tenant Here</h3>
                ...
                <input type="text" size="5"name="first_name"   id="first_name"  name="first_name" placeholder=" First Name">
                </div>  
                
                <div class="col-md-6">
                <label class="labels" >Last Name</label>
                <input type="text" size="5" name="last_name"   id="last_name"   placeholder="Last Name">
                </div>
                </div>
                ...
                <input type="text" size="5"name="gender"   id="gender"   placeholder=" Gender">
                </div>
                </div>
                ...
                <input type="text"size="15" name="emailID"   id="emailID"   placeholder=" Email">
                </div>
                </div>
                ...
                <input type="text"name="phone_no" size="15" id="phone_no" placeholder="Phone Number">
                </div>
                </div>
