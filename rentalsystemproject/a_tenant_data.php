...
<div class="home-content">
    ...
    <div class="box">
            <div class="left-side">
              <div class="box-topic">
              <a href="a_tenant_add.php" >Add Tenant</a>
                </div>
            </div>
    ...
    <?php foreach ($result as $row) 
    {
      ?>                  <div class="col-md-4 " >
                            ...
                            <tr>
                             ...
                             <tr>
                            <td>Email id:</td>
                            <td title="<?php echo $row['emailID'];?> "><span style="width:10px;text-overflow:ellipsis;overflow: hidden;white-space: nowrap;background:pink;"> <?php echo $row['emailID'];?></span></td></tr>
                            <tr>
                             <td>Username:</td>
